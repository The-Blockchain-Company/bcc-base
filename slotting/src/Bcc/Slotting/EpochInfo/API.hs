...
module Bcc.Slotting.EpochInfo.API
  ( EpochInfo (..),
    epochInfoSize,
    epochInfoFirst,
    epochInfoEpoch,
...
import Bcc.Slotting.Time (RelativeTime, SystemStart, fromRelativeTime)
...
-- | Unhelpful instance, but this type occurs in records (eg @Sophie.Globals@)

  ...
  pkgSet = haskell-nix.cabalProject {
    ...
    modules = [
      ...
      }
      {
        ...
        packages.bcc-crypto-class.configureFlags = [ "--ghc-option=-Werror" ];
        packages.bcc-crypto-class.components.library.pkgconfig = lib.mkForce [[ buildPackages.libsodium-vrf ]];
